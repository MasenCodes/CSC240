...
class Turtle : public Animal {
  public:
    Turtle(string name = "Turtle") : Animal(name) {}

    void speak() {
      cout << n << ": Gubble Gubble" << endl; 
      cout << "                             ___-------___" << endl;
      cout << "                         _-~~             ~~-_ " << endl;
      cout << "                      _-~                    /~-_" << endl;
      cout << "   /^\\__/^\\         /~  \\                   /    \\" << endl;
      cout << " /|  O|| O|        /      \\_______________/        \\" << endl;
      cout << "| |___||__|      /       /                \\          \\" << endl;
      cout << "|          \\    /      /                    \\          \\" << endl;
      cout << "|   (_______) /______/                        \\_________ \\" << endl;
      cout << "|         / /         \\                      /            \\" << endl;
      cout << " \\         \\^\\         \\                  /               \\     /" << endl;
      cout << "   \\         ||           \\______________/      _-_       //\\__//" << endl;
      cout << "     \\       ||------_-~~-_ ------------- \\ --/~   ~\\    || __/" << endl;
      cout << "       ~-----||====/~     |==================|       |/~~~~~" << endl;
      cout << "        (_(__/  ./     /                    \\_\\      \\." << endl;
...
int main() {
  ...
  */
  ...
  animals[0] = new Turtle("Bubbles");
  animals[1] = new Dog("Rufus");
  animals[2] = new Cat("Sylvester");

  for(int i = 0; i < 3; i++) {
    animal_pointer = animals[i];
    animal_pointer->speak();
    animal_pointer->move();
  }
